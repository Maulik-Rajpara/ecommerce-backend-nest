...
export class AddCart1775492022800 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "categories" ALTER COLUMN "image" SET NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
       ...
       // await queryRunner.query(`ALTER TABLE "products" DROP CONSTRAINT "FK_ff56834e735fa78a15d0cf21926"`);
        ...
        await queryRunner.query(`ALTER TABLE "categories" ALTER COLUMN "image" DROP NOT NULL`);
